...
private:
    Nodo<T> *_cabecera, *_cola; //< Puntero a mi nodo cabecera y a mi nodo cola
};
...
/**
 * @brief Lista vacia
 * @return True si mi lista esta vacia y false en otro caso
 * @post Saber si mi lista esta vacia
 */
template<class T>
bool ListaEnlazada<T>::vacia() {
    if (_cabecera != 0)
        return false;
    return true;
}
